...
export default function App() {
   ...
   * - DO NOT mint or transfer from the client.
   * - We just confirm to the user that payment is submitted.
   * - Thirdweb Pay + Netlify webhook will handle PATRON transfer
   *   from the USPPA treasury to the buyer's wallet.
   */
  const handleCheckoutSuccess = (result) => {
    console.log("Checkout success:", result);

    const paid = result?.amountPaid ?? normalizedAmount;
    ...
    alert(
      "Payment submitted successfully.\n\n" +
        ...
        `Wallet: ${wallet}\n\n` +
        "Once the payment is fully confirmed, the USPPA treasury " +
        "will automatically send PATRON to your Patron Wallet via our webhook.\n\n" +
        "If you do not see PATRON after a short while, contact support with your wallet address."
    );
  };
                ...
                >
                  ...
                  <CheckoutBoundary>
                    <CheckoutWidget
                      ...
                      seller={"0xfee3c75691e8c10ed4246b10635b19bfff06ce16"} // treasury / SELLER_ADDRESS
                      buttonLabel={"BUY PATRON (USDC on Base)"}
                      theme={patronCheckoutTheme}
                      // ✅ Critical: carry buyer wallet into webhook for all flows
