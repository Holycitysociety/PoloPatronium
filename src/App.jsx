  ...
  return (
    <div className="page">
      ...
      <main>
        ...
        <section className="brand-row" id="brands" ref={roadmapGateRef}>
          ...
          <p className="roadmap-footnote">
            ...
            Patrons Society using Patronium, the patronage token of the Society,
      ...
      <footer>
        ...
        <div>STEWARD OF THE HOLY CITY SOCIETY ECOSYSTEM</div>
        <div>PATRON BUILT ON BASE</div>
      </footer>
    </div>
  );
}